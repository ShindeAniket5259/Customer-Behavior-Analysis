...
Visualized key metrics using bar charts, boxplots, and heatmaps
...
Top 5 products/customers by revenue

Monthly sales trends

Average performance metrics

Aggregations and joins for combined insights

5. Power BI Dashboard

Connected Power BI to the cleaned dataset

Created key visuals such as:

KPI Cards (Total Sales, Average Profit, etc.)

Category-wise breakdowns (using bar/pie charts)
...
Page 4: Regional/Department Performance
